...
export interface VenueDraft {
   ...
   * never lands there. */
  sports: string[];
  /** Per-COURT competition reservations (spec 2026-08-16): court index (1-based)
...
export function VenueRow({
  ...
  /** Competition leaves of this tournament — offered per court so a court can
   * be reserved for one category ("U14 · Boys") rather than a whole sport. */
  competitionOptions?: { key: string; label: string }[];
